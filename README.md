...
Новое:
- комиксы [comix]
- документация по железу+программированию [documentation] - собирать как солюшены
- документация по эмуляторам [emulator] - собирать как солюшены, но это будут ссылки
...
TODO magazines - если группированы на странице то выводить все данные в книжном виде. - тут же исправить баг с первой книгой
...
TODO убирать кнопку скачивания при определённых условиях (сайт)
...
TODO высший пилотаж - перелинковать книги где необходимо (например, 50 игр для 3DO)
Open Graph - подумать.
