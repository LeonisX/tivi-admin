...
1. Теги - в описании, ключевых словах, в кратком и полном виде. Брать только текущую платформу.
2. Теги - в тексте
3. Дополнительные теги в тексте
4. Страницы упоминаний (альт теги) nes_citation
5. Страницы книг в поиске nes_search
6. Дампить журналы - все на одной странице с картинками. Даты и данные выводить, издателя - только если меняется
7. Страницы со ссылками на журналы (альт теги) nes_magazines
