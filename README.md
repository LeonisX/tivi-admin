...
7. Дампить журналы - все на одной странице с картинками. Даты и данные выводить, издателя - только если меняется
...
Их надо вынести в журналы. А мануалы распаковывать как мануалы
...
TODO magazines - если группированы на странице то выводить все данные в книжном виде.
