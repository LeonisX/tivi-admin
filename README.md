...
1. [x] Сравниловка - сравнивать две базы калибре, выводить разницу.
Есть внутренние списки - для них нужно ручное форматирование.
2. [x] Результат сравнения: Map<CalibreBook, Pair<String, String>>
3. [x] Выводить:
> 40 игр 3DO:\
...
Появились трудности с корректным дампом базы данных.
Как вариант - дампись в файл, возвращать ссылку.
Для этого следует доработать дампер под себя

То же самое касается и запросов, особенно больших - строить дамп, заливать и выполнять на месте
