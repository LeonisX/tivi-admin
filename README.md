...
Что делать с некоторыми архивами? Например, Радио или мануалы для PS - они распаковываются :(
Их надо вынести в журналы.
...
- TODO занести комиксы в DB. Генерить страницу с комиксами дл каждой системы.
