...
TODO по-прежнему - дампить базу над которой работаю, дампить калибре

TODO: тесты Calibre: объект в базу (свою), потом оттуда, потом в файл-обратно. всё сравнивать. потом снести тестовую базу
